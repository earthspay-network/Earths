...
import com.earthspay.lang.v1.traits.DataType
...
import com.earthspay.transaction.{Authorized, CreateAliasTransactionV1, DataTransaction, Transaction}
...
object ExtractInfo extends App with ScorexLogging {
  ...
  try {
    val state = new LevelDBWriter(db, earthsSettings.blockchainSettings.functionalitySettings)
