package com.earthspay.lang.contract
...
import com.earthspay.lang.v1.compiler.{CompilationError, Terms}
...
object Contract {
  ...
  case class CallableAnnotation(invocationArgName: String) extends Annotation {
    lazy val dic = Map(invocationArgName -> com.earthspay.lang.v1.evaluator.ctx.impl.earths.Types.invocationType.typeRef)
  }
  case class VerifierAnnotation(invocationArgName: String) extends Annotation {
    lazy val dic = Map(invocationArgName -> EarthsContext.verifierInput.typeRef)
  }
