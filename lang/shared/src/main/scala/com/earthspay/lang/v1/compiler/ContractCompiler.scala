...
import com.earthspay.lang.contract.Contract._
import com.earthspay.lang.v1.compiler.CompilationError.Generic
import com.earthspay.lang.v1.compiler.CompilerContext.vars
import com.earthspay.lang.v1.compiler.ExpressionCompiler._
import com.earthspay.lang.v1.compiler.Terms.DECLARATION
import com.earthspay.lang.v1.compiler.Types.{BOOLEAN, UNION}
import com.earthspay.lang.v1.evaluator.ctx.FunctionTypeSignature
import com.earthspay.lang.v1.evaluator.ctx.impl.earths.{FieldNames, EarthsContext}
import com.earthspay.lang.v1.parser.Expressions.FUNC
import com.earthspay.lang.v1.parser.{Expressions, Parser}
import com.earthspay.lang.v1.task.imports._
import com.earthspay.lang.v1.{FunctionHeader, compiler}
        ...
        for {
          _ <- Either
            .cond(
              tpe match {
                case _
                    if tpe <= UNION(EarthsContext.writeSetType.typeRef,
                                    EarthsContext.contractTransferSetType.typeRef,
                                    EarthsContext.contractResultType.typeRef) =>
                  true
                case _ => false
              },
              (),
