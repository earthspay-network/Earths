...
import com.earthspay.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext}
import com.earthspay.lang.v1.evaluator.ctx.impl.PureContext.fromOption
...
object EarthsContext {
  ...
  def build(env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.earthspay.lang.v1.compiler.Types.UNION.create(com.earthspay.lang.v1.compiler.Types.UNIT +: anyTransactionType.l)
    ...
    val earthsBalanceF: UserFunction = UserFunction("earthsBalance", LONG, "@addressOrAlias" -> addressOrAliasType) {
...
//    }
    ...
    val vars: Map[String, (FINAL, LazyVal)] = Map(
      ("height", (com.earthspay.lang.v1.compiler.Types.LONG, LazyVal(EitherT(heightCoeval)))),
...
//      txHeightByIdF,
    ...
    CTX(Types.earthsTypes, vars, functions)
  }
}
