package com.earthspay.lang.v1.evaluator.ctx.impl.earths

import cats.data.EitherT
import cats.implicits._
import com.earthspay.lang.ScriptVersion
import com.earthspay.lang.v1.compiler.Terms._
import com.earthspay.lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
import com.earthspay.lang.v1.evaluator.FunctionIds._
import com.earthspay.lang.v1.evaluator.ctx._
import com.earthspay.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, _}
import com.earthspay.lang.v1.traits._
import com.earthspay.lang.v1.traits.domain.{OrdType, Recipient}
import com.earthspay.lang.v1.{CTX, FunctionHeader}
import monix.eval.Coeval
import scodec.bits.ByteVector

object EarthsContext {

  import Bindings._
  import Types._
  import com.earthspay.lang.v1.evaluator.ctx.impl.converters._
  ...
  def build(version: ScriptVersion, env: Environment, isTokenContext: Boolean): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.earthspay.lang.v1.compiler.Types.UNION.create(UNIT +: anyTransactionType.l)
    ...
    val assetBalanceF: BaseFunction =
      NativeFunction(
        ...
        ("addressOrAlias", addressOrAliasType, "account"),
        ("assetId", UNION(UNIT, BYTEVECTOR), "assetId (EARTHS if none)")
      ) {
    ...
    val earthsBalanceF: UserFunction =
      UserFunction("earthsBalance", LONG, "get EARTHS balanse for account", ("@addressOrAlias", addressOrAliasType, "account")) {
    ...
    val commonVars = Map(
      ("height", ((com.earthspay.lang.v1.compiler.Types.LONG, "Current blockchain height"), LazyVal(EitherT(heightCoeval)))),
    ...
    val types = buildEarthsTypes(proofsEnabled)
