...
import com.earthspay.lang.v1.evaluator.ctx.impl.converters
import com.earthspay.lang.v1.traits.domain.Tx._
...
object Bindings {
  ...
  def buildPayment(mpmt: Option[Tx.Pmt]): CaseObj = mpmt match {
    case None => com.earthspay.lang.v1.evaluator.ctx.impl.unit
    case Some(pmt) =>
      CaseObj(
        paymentType.typeRef,
        Map(
