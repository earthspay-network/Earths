...
import com.earthspay.lang.v1.evaluator.ctx.impl._
import com.earthspay.lang.v1.evaluator.ctx.{CaseType, DefinedType, UnionType}
...
object Types {
  ...
  def buildEarthsTypes(proofsEnabled: Boolean, v: StdLibVersion): Seq[DefinedType] = {
