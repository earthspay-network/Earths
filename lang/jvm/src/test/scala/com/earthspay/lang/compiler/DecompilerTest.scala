...
import com.earthspay.lang.v1.compiler.{Decompiler, Terms}
...
class DecompilerTest extends PropSpec with PropertyChecks with Matchers {
  ...
  val CTX: CTX =
    Monoid.combineAll(Seq(PureContext.build(com.earthspay.lang.StdLibVersion.V3), CryptoContext.build(Global)))
