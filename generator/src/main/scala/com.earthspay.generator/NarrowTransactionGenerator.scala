...
import cats.Show
import com.earthspay.generator.NarrowTransactionGenerator.Settings
import com.earthspay.state.DataEntry.{MaxValueSize, Type}
import com.earthspay.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, EitherExt2, IntegerDataEntry, StringDataEntry}
import org.slf4j.LoggerFactory
import com.earthspay.account.{Alias, PrivateKeyAccount}
...
import com.earthspay.transaction.lease.{LeaseCancelTransaction, LeaseCancelTransactionV1, LeaseTransactionV1}
  ...
  def generate(n: Int): Seq[Transaction] = {
    ...
    val tradeAssetIssue = IssueTransactionV1
      .selfSigned(
        ...
        "TRADE".getBytes,
        "Earths DEX is the best exchange ever".getBytes,
        100000000,
        2,
        reissuable = false,
