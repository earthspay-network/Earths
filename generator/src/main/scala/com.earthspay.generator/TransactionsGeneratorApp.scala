...
import com.earthspay.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.earthspay.generator.cli.ScoptImplicits
import com.earthspay.generator.config.FicusImplicits
import com.earthspay.generator.utils.Universe
...
import com.earthspay.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader        = com.earthspay.settings.inetSocketAddressReader
