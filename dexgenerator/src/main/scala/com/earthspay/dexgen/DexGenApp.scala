...
import com.earthspay.account.{AddressOrAlias, AddressScheme, PrivateKeyAccount}
import com.earthspay.api.http.assets.{SignedIssueV2Request, SignedMassTransferRequest}
import com.earthspay.common.state.ByteStr
import com.earthspay.dexgen.cli.ScoptImplicits
import com.earthspay.dexgen.config.FicusImplicits
import com.earthspay.dexgen.utils.{ApiRequests, GenOrderType}
import com.earthspay.it.api.Transaction
import com.earthspay.it.util.GlobalTimer
...
import com.earthspay.transaction.transfer.MassTransferTransaction
...
object DexGenApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  val parser = new OptionParser[GeneratorSettings]("generator") {
    head("TransactionsGenerator - Earths load testing transactions generator")
