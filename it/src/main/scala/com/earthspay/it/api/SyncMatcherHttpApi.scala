...
import com.earthspay.it.api.SyncHttpApi.RequestAwaitTime
import com.earthspay.it.matcher.MatcherState
...
object SyncMatcherHttpApi extends Assertions {
  ...
  implicit class MatcherNodeExtSync(m: Node) extends Matchers {
    ...
    import com.earthspay.it.api.AsyncMatcherHttpApi.{MatcherAsyncHttpApi => async}
