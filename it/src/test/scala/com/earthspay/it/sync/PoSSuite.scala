...
import com.earthspay.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.earthspay.it.api.SyncHttpApi._
import com.earthspay.it.transactions.NodesFromDocker
import com.earthspay.it.{NodeConfigs, WaitForHeight2}
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("earths.miner.enable = yes"))
      .buildNonConflicting()
