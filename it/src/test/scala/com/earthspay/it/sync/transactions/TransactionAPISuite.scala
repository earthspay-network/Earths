...
import com.earthspay.it.api.TransactionInfo
import com.earthspay.it.transactions.NodesFromDocker
import com.earthspay.it.{Node, NodeConfigs, ReportingTestName}
...
class TransactionAPISuite extends FreeSpec with NodesFromDocker with Matchers with ReportingTestName with CancelAfterFailure {
  ...
  override def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .overrideBase(_.raw("earths.rest-api.transactions-by-address-limit=10"))
      .withDefault(1)
  ...
  val Earths: Long = 100000000L

  val AMT: Long = 1 * Earths
  val FEE: Long = (0.001 * Earths).toLong
