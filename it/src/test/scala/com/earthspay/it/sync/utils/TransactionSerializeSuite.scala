package com.earthspay.it.sync.utils

import com.earthspay.account.{Address, AddressScheme, Alias, PublicKeyAccount}
import com.earthspay.it.transactions.BaseTransactionSuite
import com.earthspay.state.{BinaryDataEntry, BooleanDataEntry, IntegerDataEntry}
import com.earthspay.transaction.{CreateAliasTransactionV1, CreateAliasTransactionV2, DataTransaction, Proofs}
...
import com.earthspay.transaction.lease.{LeaseCancelTransactionV1, LeaseCancelTransactionV2, LeaseTransactionV1, LeaseTransactionV2}
...
import com.earthspay.transaction.smart.ContractInvocationTransaction
import com.earthspay.transaction.smart.script.Script
import com.earthspay.transaction.transfer.{MassTransferTransaction, TransferTransactionV1, TransferTransactionV2}
...
class TransactionSerializeSuite extends BaseTransactionSuite with TableDrivenPropertyChecks {
  ...
  private val buyV2 = OrderV2(
    ...
    AssetPair.createAssetPair("EARTHS", "9ZDWzK53XT5bixkmMwTJi2YzgxCqn5dUajXFcT2HcFDy").get,
    OrderType.BUY,
    2,
    60.earths,
    tsOrderFrom,
  ...
  private val transfers = MassTransferTransaction
    .parseTransfersList(List(Transfer(firstAddress, 1.earths), Transfer(secondAddress, 2.earths)))
    .right
    .get
