...
import com.earthspay.it.api.OrderBookResponse
...
class MatcherRestartTestSuite extends MatcherSuiteBase {
  ...
  "check order execution" - {
    ...
    "make order and after matcher's restart try to cancel it" in {
      ...
      val orders2 =
        matcherNode.waitFor[OrderBookResponse]("Top ask has 1000 amount")(_.orderBook(aliceEarthsPair), _.asks.head.amount == 1000, 1.second)
