  ...
  "check order execution" - {
    ...
    "make order and after matcher's restart try to cancel it" in {
      ...
      val aliceOrder = matcherNode
        .placeOrder(aliceNode, aliceEarthsPair, OrderType.SELL, 500, 2.earths * Order.PriceConstant)
      ...
      val aliceSecondOrder = matcherNode.placeOrder(aliceNode, aliceEarthsPair, OrderType.SELL, 500, 2.earths * Order.PriceConstant, 5.minutes)
      ...
      val cancel = matcherNode.cancelOrder(aliceNode, aliceEarthsPair, firstOrder)
