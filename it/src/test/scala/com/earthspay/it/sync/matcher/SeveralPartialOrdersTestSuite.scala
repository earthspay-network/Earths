...
class SeveralPartialOrdersTestSuite extends MatcherSuiteBase {
  ...
  "Alice and Bob trade EARTHS-USD" - {
    ...
    "place usd-earths order" in {
      ...
      val aliceOrder2   = matcherNode.prepareOrder(aliceAcc, earthsUsdPair, OrderType.BUY, buyOrderAmount, price)
      ...
      val bobOrder2   = matcherNode.prepareOrder(bobAcc, earthsUsdPair, OrderType.SELL, sellOrderAmount, price)
      ...
      matcherNode.cancelOrder(bobAcc, earthsUsdPair, bobOrder2Id)
      matcherNode.waitOrderStatus(earthsUsdPair, bobOrder2Id, "Cancelled", 1.minute)
    ...
    "place one submitted orders and two counter" in {
      val aliceOrder1   = matcherNode.prepareOrder(aliceAcc, earthsUsdPair, OrderType.BUY, buyOrderAmount, price)
