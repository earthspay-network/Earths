...
class SeveralPartialOrdersTestSuite
  ...
  "Alice and Bob trade EARTHS-USD" - {
    ...
    "place two submitted orders and one counter" in {
      ...
      val aliceOrder1  = matcherNode.prepareOrder(aliceNode, earthsUsdPair, OrderType.BUY, buyOrderAmount, price)
      ...
      val aliceOrder2   = matcherNode.prepareOrder(aliceNode, earthsUsdPair, OrderType.BUY, buyOrderAmount, price)
      ...
      val bobOrder2   = matcherNode.prepareOrder(bobNode, earthsUsdPair, OrderType.SELL, sellOrderAmount, price)
      ...
      matcherNode.cancelOrder(bobNode, earthsUsdPair, bobOrder2Id)
      nodes.waitForHeightArise()
