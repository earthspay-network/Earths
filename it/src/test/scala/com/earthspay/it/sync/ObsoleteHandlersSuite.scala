package com.earthspay.it.sync

import com.earthspay.api.http.alias.CreateAliasV1Request
import com.earthspay.api.http.assets.{
  BurnV1Request,
  IssueV1Request,
  MassTransferRequest,
  ReissueV1Request,
...
import com.earthspay.it.api.Transaction
import com.earthspay.it.transactions.BaseTransactionSuite
import com.earthspay.transaction.transfer.TransferTransaction
import com.earthspay.api.http.DataRequest
import com.earthspay.common.state.ByteStr
import com.earthspay.state.{BinaryDataEntry, BooleanDataEntry, IntegerDataEntry, StringDataEntry}
...
class ObsoleteHandlersSuite extends BaseTransactionSuite {
  ...
  test("assets masstransfer") {
    ...
    val transfers                               = List(Transfer(secondAddress, 1.earths), Transfer(thirdAddress, 2.earths))
