...
class SetScriptTransactionSpecification extends GenericTransactionSpecification[SetScriptTransaction] {
  ...
  def transactionParser: com.earthspay.transaction.TransactionParserFor[SetScriptTransaction] = SetScriptTransaction
  ...
  def generator: Gen[((Seq[com.earthspay.transaction.Transaction], SetScriptTransaction))] = setScriptTransactionGen.map(t => (Seq(), t))
