...
import com.earthspay.transaction.assets.{IssueTransactionV1, ReissueTransactionV2}

class ReissueTransactionV2Specification extends GenericTransactionSpecification[ReissueTransactionV2] {

  def transactionParser: com.earthspay.transaction.TransactionParserFor[ReissueTransactionV2] = ReissueTransactionV2
  ...
  def generator: Gen[((Seq[com.earthspay.transaction.Transaction], ReissueTransactionV2))] =
    for {
