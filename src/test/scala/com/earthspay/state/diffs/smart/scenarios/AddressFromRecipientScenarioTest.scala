...
import com.earthspay.lang.v1.evaluator.ctx.CaseObj
import com.earthspay.lang.v1.parser.Parser
import com.earthspay.state._
import com.earthspay.state.diffs.{ENOUGH_AMT, assertDiffAndState, produce}
import com.earthspay.transaction.smart.BlockchainContext
import com.earthspay.transaction.transfer._
import com.earthspay.transaction.{CreateAliasTransaction, GenesisTransaction, Transaction}
...
class AddressFromRecipientScenarioTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with NoShrink {
  ...
  def evalScript(tx: Transaction, blockchain: Blockchain): Either[com.earthspay.lang.ExecutionError, CaseObj] = {
    val context =
    ...
    val Parsed.Success(expr, _) = Parser("""
        ...
        |  }
        |  """.stripMargin)
    val Right((typedExpr, _))   = CompilerV1(com.earthspay.utils.dummyCompilerContext, expr)
