...
import com.earthspay.lang.ScriptVersion.Versions.V2
import com.earthspay.lang.Testing.evaluated
import com.earthspay.lang.v1.compiler.CompilerV1
import com.earthspay.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_LONG, EVALUATED}
...
import com.earthspay.state.diffs.ProduceError._
...
import com.earthspay.transaction.{Proofs, ProvenTransaction, VersionedTransaction}
...
class TransactionBindingsTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with NoShrink {
  ...
  def runForAsset(script: String): Either[String, EVALUATED] = {
    ...
    import com.earthspay.lang.v1.CTX._
    ...
    val ctx =
      PureContext
        ...
        CryptoContext
          .build(Global) |+|
        EarthsContext
          .build(V2, new EarthsEnvironment(networkByte, Coeval(null), null, EmptyBlockchain), isTokenContext = true)
    ...
    val ctx =
      PureContext.build(V2) |+|
        CryptoContext
          .build(Global) |+|
        EarthsContext
          .build(V2, new EarthsEnvironment(networkByte, Coeval(t), null, EmptyBlockchain), isTokenContext = false)
