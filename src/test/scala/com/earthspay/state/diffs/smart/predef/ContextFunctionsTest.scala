...
import com.earthspay.state.diffs.{ENOUGH_AMT, assertDiffAndState}
...
import com.earthspay.utils.{Base58, dummyCompilerContext}
  ...
  val preconditionsAndPayments = for {
    ...
    untypedScript <- Gen
      ...
      .map {
        ...
        case 2 => scriptWithEarthsFunctions(dataTransaction, transfer)
