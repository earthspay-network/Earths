...
import com.earthspay.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, DataEntry, EitherExt2, IntegerDataEntry}
...
import com.earthspay.transaction.{DataTransaction, GenesisTransaction}
