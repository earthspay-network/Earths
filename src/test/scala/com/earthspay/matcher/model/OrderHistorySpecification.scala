...
import com.earthspay.matcher.model.OrderHistorySpecification._
import com.earthspay.matcher.{MatcherKeys, MatcherTestData}
...
class OrderHistorySpecification
  ...
  property("Delete order") {
    ...
    oh.openVolume(pk, pair.amountAsset) shouldBe 0 // We receive 210000000 >> 300000 EARTHS
