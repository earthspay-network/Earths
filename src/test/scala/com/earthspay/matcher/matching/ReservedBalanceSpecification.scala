package com.earthspay.matcher.matching

import akka.actor.Props
import akka.pattern.ask
import akka.util.Timeout
import com.earthspay.account.PublicKeyAccount
import com.earthspay.matcher.market.MatcherSpecLike
import com.earthspay.matcher.model.Events.{OrderAdded, OrderExecuted}
import com.earthspay.matcher.model.{LimitOrder, OrderHistoryStub}
import com.earthspay.matcher.{AssetPairDecimals, MatcherTestData, _}
...
import com.earthspay.{NTPTime, WithDB}
...
class ReservedBalanceSpecification
  ...
  val pair = AssetPair(mkAssetId("EARTHS"), mkAssetId("USD"))
