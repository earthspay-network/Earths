...
import com.earthspay.matcher.api.{MatcherResponse, OrderAccepted}
import com.earthspay.matcher.fixtures.RestartableActor
import com.earthspay.matcher.market.MatcherActor.{GetMarkets, GetMarketsResponse, MarketData}
import com.earthspay.matcher.market.OrderHistoryActor.{ValidateOrder, ValidateOrderResult}
import com.earthspay.matcher.model.OrderBook
import com.earthspay.matcher.{AssetPairBuilder, MatcherTestData}
import com.earthspay.settings.{TestFunctionalitySettings, WalletSettings}
...
class MatcherActorSpecification
  ...
  "GetMarketsResponse" should {
    "serialize to json" in {
      ...
      val json =
        GetMarketsResponse(Array(), Seq(MarketData(pair1, a1Name, earths, now, None, None), MarketData(pair2, a1Name, a2Name, now, None, None))).json

      ((json \ "markets")(0) \ "priceAsset").as[String] shouldBe AssetPair.EarthsName
      ((json \ "markets")(0) \ "priceAssetName").as[String] shouldBe earths
