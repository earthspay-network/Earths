...
import com.earthspay.api.http.{AddressApiRoute, ApiKeyNotValid}
import com.earthspay.common.utils.{Base58, Base64, EitherExt2}
import com.earthspay.http.ApiMarshallers._
// [WAIT] import com.earthspay.lang.{Global, StdLibVersion}
import com.earthspay.lang.StdLibVersion
import com.earthspay.lang.contract.Contract
import com.earthspay.lang.contract.Contract.{VerifierAnnotation, VerifierFunction}
// [WAIT] import com.earthspay.lang.v1.compiler.Decompiler
import com.earthspay.lang.v1.compiler.Terms._
// [WAIT] import com.earthspay.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
...
import com.earthspay.{NoShrink, TestTime, TestWallet, crypto}
...
// [WAIT]                                           Decompiler(
//      testContract,
//      Monoid.combineAll(Seq(PureContext.build(com.earthspay.lang.StdLibVersion.V3), CryptoContext.build(Global))).decompilerContext)
