package com.earthspay.api.http.swagger
...
class SwaggerDocService(val actorSystem: ActorSystem, val materializer: ActorMaterializer, val apiClasses: Set[Class[_]], settings: RestAPISettings)
  ...
  override val info: Info = Info(
    "The Web Interface to the Earths Full Node API",
    Version.VersionString,
    "Earths Full Node",
    "License: Apache License, Version 2.0",
    None,
    Some(License("Apache License, Version 2.0", "https://github.com/earthspay/Earths/blob/master/LICENSE"))
  )
