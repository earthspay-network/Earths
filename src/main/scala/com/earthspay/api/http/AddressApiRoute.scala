...
import com.earthspay.consensus.GeneratingBalanceProvider
...
import com.earthspay.transaction.{TransactionFactory, ValidationError}
  ...
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.SignedMessage",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.DataRequest",
