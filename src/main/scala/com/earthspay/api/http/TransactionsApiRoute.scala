...
import com.earthspay.api.http.alias.{CreateAliasV1Request, CreateAliasV2Request}
import com.earthspay.api.http.assets.SponsorFeeRequest._
import com.earthspay.api.http.assets._
import com.earthspay.api.http.leasing._
import com.earthspay.common.state.ByteStr
import com.earthspay.http.BroadcastRoute
import com.earthspay.settings.{FunctionalitySettings, RestAPISettings}
...
import com.earthspay.utils.{Time, byteStrWrites}
        ...
        json[JsObject] { jsv =>
          ...
          createTransaction(senderPk, enrichedJsv) { tx =>
            CommonValidation.getMinFee(blockchain, functionalitySettings, blockchain.height, tx).map {
              case (assetId, assetAmount, earthsAmount) =>
                Json.obj(
                  "feeAssetId" -> assetId,
