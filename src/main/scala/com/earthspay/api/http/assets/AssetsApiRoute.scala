...
import com.earthspay.transaction.assets.IssueTransaction
...
import com.earthspay.transaction.{AssetIdStringLength, TransactionFactory}
import com.earthspay.utils.{Base58, Time}
    ...
    (get & path(Segment / "distribution")) { assetId =>
      complete {
        Success(assetId).filter(_.length <= AssetIdStringLength).flatMap(Base58.decode) match {
          ...
          case Failure(_) =>
            ApiError.fromValidationError(com.earthspay.transaction.ValidationError.GenericError("Must be base58-encoded assetId"))
        }
      }
    }
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.assets.TransferV2Request"
      )
    ))
  def transfer: Route =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.assets.MassTransferRequest"
      )
    ))
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.assets.IssueV1Request",
        example =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.assets.ReissueV1Request",
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.assets.BurnV1Request",
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.api.http.assets.SponsorFeeRequest",
