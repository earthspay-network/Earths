...
import com.earthspay.matcher.AddressActor.GetOrderStatus
import com.earthspay.matcher.AddressDirectory.{Envelope => Env}
import com.earthspay.matcher.Matcher.StoreEvent
import com.earthspay.matcher.market.MatcherActor.{GetMarkets, GetSnapshotOffsets, MarketData, SnapshotOffsetsResponse}
import com.earthspay.matcher.market.OrderBookActor._
import com.earthspay.matcher.model._
import com.earthspay.matcher.queue.{QueueEvent, QueueEventWithMeta}
import com.earthspay.matcher.{AddressActor, AssetPairBuilder, Matcher}
import com.earthspay.metrics.TimerExt
import com.earthspay.settings.{RestAPISettings, EarthsSettings}
import com.earthspay.transaction.AssetId
import com.earthspay.transaction.assets.exchange.OrderJson._
...
case class MatcherApiRoute(assetPairBuilder: AssetPairBuilder,
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "amountAsset", value = "Amount Asset Id in Pair, or 'EARTHS'", dataType = "string", paramType = "path"),
      new ApiImplicitParam(name = "priceAsset", value = "Price Asset Id in Pair, or 'EARTHS'", dataType = "string", paramType = "path"),
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.transaction.assets.exchange.Order"
      )
    ))
  ...
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.earthspay.matcher.api.CancelOrderRequest"
      )
    ))
