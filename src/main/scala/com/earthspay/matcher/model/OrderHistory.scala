...
import com.earthspay.database.{DBExt, Key, RW}
import com.earthspay.matcher.api.DBUtils
import com.earthspay.matcher.model.Events._
import com.earthspay.matcher.model.LimitOrder._
import com.earthspay.matcher.{MatcherKeys, MatcherSettings, OrderAssets}
...
class OrderHistory(db: DB, settings: MatcherSettings) extends ScorexLogging {
  ...
  import com.earthspay.matcher.MatcherKeys._
