...
import com.earthspay.api.http.CompositeHttpService
import com.earthspay.common.utils.EitherExt2
import com.earthspay.db._
import com.earthspay.matcher.Matcher.Status
import com.earthspay.matcher.api.{MatcherApiRoute, OrderBookSnapshotHttpCache}
import com.earthspay.matcher.market.OrderBookActor.MarketStatus
import com.earthspay.matcher.market.{MatcherActor, MatcherTransactionWriter, OrderBookActor}
import com.earthspay.matcher.model.{ExchangeTransactionCreator, OrderBook, OrderValidator}
import com.earthspay.matcher.queue._
import com.earthspay.network._
import com.earthspay.settings.EarthsSettings
import com.earthspay.state.{Blockchain, VolumeAndFee}
import com.earthspay.transaction.AssetId
import com.earthspay.transaction.assets.exchange.{AssetPair, Order}
import com.earthspay.utils.{ErrorStartingMatcher, ScorexLogging, Time, forceStopApplication}
...
object Matcher extends ScorexLogging {
  ...
  def apply(actorSystem: ActorSystem,
            ...
            blockchain: Blockchain,
            spendableBalanceChanged: Observable[(Address, Option[AssetId])],
            settings: EarthsSettings): Option[Matcher] =
    try {
      val privateKey = (for {
