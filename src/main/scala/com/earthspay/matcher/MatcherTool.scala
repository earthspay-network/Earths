...
import com.earthspay.crypto.DigestSize
import com.earthspay.database._
import com.earthspay.db.openDB
import com.earthspay.matcher.api.DBUtils
import com.earthspay.matcher.market.{MatcherActor, OrderBookActor}
import com.earthspay.matcher.model.{LimitOrder, OrderBook}
...
object MatcherTool extends ScorexLogging {
  ...
  def createPairIndices(db: DB): Unit = {
    import com.earthspay.matcher.util.Codecs.ByteBufferExt
  ...
  def main(args: Array[String]): Unit = {
    ...
    val settings     = EarthsSettings.fromConfig(actualConfig)
