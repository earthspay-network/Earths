...
import com.earthspay.lang.v1.compiler.Terms.{CONST_LONG, CaseObj}
import com.earthspay.lang.v1.compiler.Types.FINAL
import com.earthspay.lang.v1.evaluator.FunctionIds._
import com.earthspay.lang.v1.evaluator.ctx._
import com.earthspay.lang.v1.evaluator.ctx.impl.earths.Bindings.{ordType, orderObject}
import com.earthspay.lang.v1.evaluator.ctx.impl.earths.Types._
import com.earthspay.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext, _}
import com.earthspay.lang.v1.traits.domain.OrdType
import com.earthspay.lang.v1.{CTX, FunctionHeader}
import com.earthspay.transaction.assets.exchange.Order
import com.earthspay.transaction.smart.RealTransactionWrapper
...
object MatcherContext {
  ...
  def build(version: StdLibVersion, nByte: Byte, in: Coeval[Order], proofsEnabled: Boolean): EvaluationContext = {
    ...
    val commonMatcherVars: Map[String, ((FINAL, String), LazyVal)] = Map(
      ("height", ((com.earthspay.lang.v1.compiler.Types.LONG, "undefined height placeholder"), LazyVal(EitherT(heightCoeval)))),
    ...
    val earthsBalanceF: BaseFunction         = inaccessibleUserFunction("earthsBalanceF")
