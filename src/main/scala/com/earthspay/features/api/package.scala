package com.earthspay.features

import com.earthspay.features.BlockchainFeatureStatus.{Activated, Approved, Undefined}
import com.earthspay.features.api.NodeFeatureStatus.{Implemented, NotImplemented, Voted}
