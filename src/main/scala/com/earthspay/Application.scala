...
import com.earthspay.utils.{NTP, ScorexLogging, SystemInformationReporter, forceStopApplication}
...
class Application(val actorSystem: ActorSystem, val settings: EarthsSettings, configRoot: ConfigObject, time: NTP) extends ScorexLogging {
