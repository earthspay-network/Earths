...
import com.earthspay.settings.{BlockchainSettings, SynchronizationSettings}
...
import com.earthspay.utils.{BaseTargetReachedMaximum, ScorexLogging, forceStopApplication}
