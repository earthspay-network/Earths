...
import com.earthspay.consensus.TransactionsOrdering
import com.earthspay.metrics.Instrumented
import com.earthspay.mining.MultiDimensionalMiningConstraint
import com.earthspay.settings.{FunctionalitySettings, UtxSettings}
import com.earthspay.state.diffs.TransactionDiffer
import com.earthspay.state.reader.CompositeBlockchain.composite
import com.earthspay.state.{Blockchain, ByteStr, Diff, Portfolio}
import com.earthspay.transaction.ValidationError.{GenericError, SenderIsBlacklisted}
import com.earthspay.transaction._
import com.earthspay.transaction.assets.ReissueTransaction
...
class UtxPoolImpl(time: Time, blockchain: Blockchain, feeCalculator: FeeCalculator, fs: FunctionalitySettings, utxSettings: UtxSettings)
  ...
  import com.earthspay.utx.UtxPoolImpl._
