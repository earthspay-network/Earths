...
object Keys {
  ...
  def earthsBalanceHistory(addressId: BigInt): Key[Seq[Int]] = historyKey(5, addressId.toByteArray)
  ...
  val addressesForEarthsSeqNr: Key[Int]                = intKey(37)
  def addressesForEarths(seqNr: Int): Key[Seq[BigInt]] = Key(h(38, seqNr), readBigIntSeq, writeBigIntSeq)
