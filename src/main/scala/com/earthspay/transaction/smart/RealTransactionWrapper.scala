...
import com.earthspay.account.{Address, AddressOrAlias, Alias}
import com.earthspay.common.state.ByteStr
import com.earthspay.lang.v1.traits.domain.Tx.{Header, Proven}
import com.earthspay.lang.v1.traits.domain._
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.earthspay.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
