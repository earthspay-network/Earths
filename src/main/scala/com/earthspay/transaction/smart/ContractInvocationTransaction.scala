...
import com.earthspay.lang.v1.compiler.Terms.{EVALUATED, FUNCTION_CALL, REF}
...
object ContractInvocationTransaction extends TransactionParserFor[ContractInvocationTransaction] with TransactionParser.MultipleVersions {
  ...
  def functionCallToJson(fc: Terms.FUNCTION_CALL): JsObject = {
    Json.obj(
      "function" -> JsString(fc.function.asInstanceOf[com.earthspay.lang.v1.FunctionHeader.User].name),
      "args" -> JsArray(
        fc.args.map {
