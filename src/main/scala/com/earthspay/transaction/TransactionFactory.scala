...
import com.earthspay.api.http.DataRequest._
import com.earthspay.api.http.alias.{CreateAliasV1Request, CreateAliasV2Request, SignedCreateAliasV1Request, SignedCreateAliasV2Request}
import com.earthspay.api.http.assets.SponsorFeeRequest._
import com.earthspay.api.http.assets._
import com.earthspay.api.http.leasing.{LeaseCancelV1Request, LeaseCancelV2Request, LeaseV1Request, LeaseV2Request, _}
import com.earthspay.api.http.{DataRequest, SignedDataRequest, versionReads}
...
import com.earthspay.transaction.assets.exchange.{ExchangeTransactionV1, ExchangeTransactionV2}
