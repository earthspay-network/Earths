...
import com.earthspay.serialization.{BytesSerializable, Deser, JsonSerializable}
import com.earthspay.state.ByteStr
import com.earthspay.transaction.ValidationError.{GenericError, InvalidSignature}
