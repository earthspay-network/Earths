...
object FunctionalitySettings {
  val MAINNET = apply(
    ...
    allowTemporaryNegativeUntil = 1544864400000L,
    generationBalanceDepthFrom50To1000AfterHeight = 0,
    minimalGeneratingBalanceAfter = 1544864400000L,
    allowTransactionsFromFutureUntil = 1544864400000L,
    allowUnissuedAssetsUntil = 1544864400000L,
    allowInvalidReissueInSameBlockUntilTimestamp = 1544864400000L,
    allowMultipleLeaseCancelTransactionUntilTimestamp = 1544864400000L,
