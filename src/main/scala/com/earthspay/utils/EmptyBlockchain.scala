...
import com.earthspay.state.{AccountDataInfo, AssetDescription, BalanceSnapshot, Blockchain, ByteStr, DataEntry, Diff, Portfolio, VolumeAndFee}
...
import com.earthspay.transaction.{AssetId, Transaction, ValidationError}
...
object EmptyBlockchain extends Blockchain {
  ...
  override def earthsDistribution(height: Int): Map[Address, Long] = Map.empty
