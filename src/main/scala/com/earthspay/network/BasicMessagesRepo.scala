...
import com.earthspay.mining.Miner.MaxTransactionsPerMicroblock
...
import com.earthspay.network.message.Message._
import com.earthspay.network.message._
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://earthspay.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
