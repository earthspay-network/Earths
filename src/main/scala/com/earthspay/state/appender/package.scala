...
import com.earthspay.consensus.{GeneratingBalanceProvider, PoSSelector, TransactionsOrdering}
import com.earthspay.mining._
import com.earthspay.network._
import com.earthspay.settings.{FunctionalitySettings, EarthsSettings}
import com.earthspay.utx.UtxPool
import io.netty.channel.Channel
import io.netty.channel.group.ChannelGroup
import monix.eval.Task
import com.earthspay.block.Block
import com.earthspay.transaction.ValidationError.{BlockAppendError, BlockFromFuture, GenericError}
...
package object appender extends ScorexLogging {
  ...
  private[appender] def appendBlock(checkpoint: CheckpointService,
                                    ...
                                    pos: PoSSelector,
                                    time: Time,
                                    settings: EarthsSettings)(block: Block): Either[ValidationError, Option[Int]] =
    for {
      _ <- Either.cond(
  ...
  private def blockConsensusValidation(blockchain: Blockchain, settings: EarthsSettings, pos: PoSSelector, currentTs: Long, block: Block)(
