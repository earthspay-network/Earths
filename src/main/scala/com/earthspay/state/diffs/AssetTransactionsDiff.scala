...
import com.earthspay.state.{AssetInfo, Blockchain, Diff, LeaseBalance, Portfolio, SponsorshipValue}
...
import com.earthspay.transaction.{AssetId, ProvenTransaction, ValidationError}
