...
import com.earthspay.state.patch.{CancelAllLeases, CancelInvalidLeaseIn, CancelLeaseOverflow}
...
import com.earthspay.transaction.ValidationError.ActivationError
            ...
            balance = portfolio.balance +
              portfolio.assets.map {
                case (assetId, assetFee) =>
                  ...
                  Sponsorship.toEarths(assetFee, baseFee)
              }.sum)
        else portfolio
