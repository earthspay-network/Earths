...
import com.earthspay.api.http.{ApiRoute, DiscontinuedApi}
...
@Api(value = "earths")
@Deprecated
case class EarthsApiRoute(settings: RestAPISettings, wallet: Wallet, utx: UtxPool, allChannels: ChannelGroup, time: Time)
    extends ApiRoute
    with BroadcastRoute {

  override lazy val route = pathPrefix("earths") {
